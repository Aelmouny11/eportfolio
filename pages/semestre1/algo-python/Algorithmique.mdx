...
<div class="rounded-md border border-blue-500 bg-slate-200/20 p-2">
  - Un algorithme représente une séquence d’instructions (Actions), logiquement
  ordonnées, qui permet de résoudre un problème donné. - Un algorithme est lié à
  un problème.
</div>
...
- Données : Identificateur - Chaque donnée (Variable ou constante) manipulée par un
  algorithme est désignées par un nom unique : IDENTIFICATEUR. - Identificateur : c’est une chaîne de caractères alphanumérique
...
- Type booléen - Le type booléen stocke uniquement les valeurs logiques VRAI et FAUX. - On peut représenter ces notions abstraites de VRAI et de FAUX par tout ce
...
<div class="p-2 rounded-md bg-blue-300/30">
