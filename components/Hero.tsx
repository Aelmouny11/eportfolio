...
const HeroSection = () => {
	return (
		<div className="grid min-h-screen px-2 py-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
			<div className="grid items-center grid-cols-1 gap-8 lg:grid-cols-2">	
				...
				<div className="flex flex-col justify-center gap-4">
					...
					<p className="mb-8 text-lg sm:text-xl md:text-2xl ">
						Motivés par l'informatique et tous les domaines connexes. En outre, j'admire l'utilisation des nouvelles technologies et les met en œuvre au quotidien pour assurer l'optimisation de toutes les activités quotidiennes.

						Maintenant, je suis une stagiaire en enseignement de l'informatique au centre CRMEF à Marrakech.
					</p>
					<div>
						<Link
							href="/msp"
